...
namespace DeliverTableInfrastructure.Migrations
{
    ...
    [Migration("20260326113602_AddEmailJobs")]
    partial class AddEmailJobs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeliverTableInfrastructure.Models.CustomerRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DeliverTableInfrastructure.Models.CustomerRating", b =>
                {
                    ...
                    b.HasOne("DeliverTableInfrastructure.Models.User", "RatedCustomerUser")
                        .WithMany()
                    ...
                    b.HasOne("DeliverTableInfrastructure.Models.User", "RestaurantUser")
                        .WithMany()
