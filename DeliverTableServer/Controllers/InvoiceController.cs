...
public class InvoiceController(IInvoiceService invoiceService) : ControllerBase
{
        ...
        CancellationToken ct = default)
    {
        ...
        var result = await _invoiceService.ListForMeAsync(userId, page, pageSize, ct);
        ...
        CancellationToken ct = default)
    {
        ...
        var result = await _invoiceService.ListForRestaurantAsync(id, userId, isAdmin, page, pageSize, ct);
        return result.ToOkResult();
    }
    ...
    public async Task<IActionResult> Download([FromRoute] int id, CancellationToken ct)
    {
        ...
        var result = await _invoiceService.GetPdfStreamAsync(id, userId, isAdmin, isRestaurantOwner, ct);
