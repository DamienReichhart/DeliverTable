...
public class AdminRestaurantController(IAdminRestaurantService adminRestaurantService) : ControllerBase
{
    ...
    {
        var result = await _adminRestaurantService.GetAllAsync(ct);
    ...
    {
        var result = await _adminRestaurantService.GetByIdAsync(id, ct);
        return result.ToOkResult();
    }
    ...
    {
        var result = await _adminRestaurantService.UpdateAsync(id, request, ct);
        return result.ToOkResult();
    }
    ...
    {
        var result = await _adminRestaurantService.DeleteAsync(id, ct);
