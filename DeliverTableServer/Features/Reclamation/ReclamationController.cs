...
namespace DeliverTableServer.Features.Reclamation;
    ...
    ) : ControllerBase
{
    ...
    {
        ServiceResult<List<ReclamationDto>> result = await _reclamationService.GetAllReclamations(query);
    ...
    {
        ServiceResult<ReclamationDto> result = await _reclamationService.GetReclamationById(id);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult<ReclamationDto> result = await _reclamationService.CreateReclamation(reclamation, Request.Form.Files);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult<ReclamationDto> result = await _reclamationService.UpdateReclamation(id, reclamation);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult result = await _reclamationService.DeleteReclamation(id);
    ...
    {
        ServiceResult<List<ReclamationDto>> result = await _reclamationService.GetReclamationsByUser(userId);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult<ReclamationDto> result = await _reclamationService.GetReclamationsByOrderId(orderId);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult<List<ReclamationDto>> result = await _reclamationService.GetReclamationsByRestaurant(restaurantId);
        return result.ToOkResult();
    }
    ...
    public async Task<IActionResult> GetMyRestaurantReclamations()
    {
        ...
        ServiceResult<List<ReclamationDto>> result = await _reclamationService.GetReclamationsByRestaurantOwner(ownerId);
        return result.ToOkResult();
    }
    ...
    {
        if (!this.TryGetUserId(out int ownerId)) return Unauthorized();
        ServiceResult<ReclamationDto> result = await _reclamationService.RefundReclamation(id, ownerId, dto);
        return result.ToOkResult();
    }
    ...
    {
        if (!this.TryGetUserId(out int ownerId)) return Unauthorized();
        ServiceResult<ReclamationDto> result = await _reclamationService.ResolveReclamation(id, ownerId);
        return result.ToOkResult();
    }
    ...
    public async Task<IActionResult> Contest([FromRoute] int id)
    {
        ...
        ServiceResult<ReclamationDto> result = await _reclamationService.ContestReclamation(id, customerId);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult<ReclamationDto> result = await _reclamationService.CompleteReclamation(id);
        return result.ToOkResult();
    }
}
