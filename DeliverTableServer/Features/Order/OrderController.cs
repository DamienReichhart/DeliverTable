...
namespace DeliverTableServer.Features.Order;
...
public class OrderController(IOrderService orderService) : ControllerBase
{
    ...
    public async Task<IActionResult> CreateOrder([FromBody] CreateOrderRequest request, CancellationToken ct)
    {
        ...
        ServiceResult<CreateOrderResponse> result = await _orderService.CreateFromCartAsync(userId, request, ct);
    ...
    public async Task<IActionResult> GetById([FromRoute] int id, CancellationToken ct)
    {
        ...
        ServiceResult<OrderDto> result = await _orderService.GetByIdAsync(id, userId, ct);
        return result.ToOkResult();
    }
    ...
    public async Task<IActionResult> GetMyOrders([FromQuery] OrderQuery query, CancellationToken ct)
    {
        ...
        ServiceResult<PaginatedResult<OrderDto>> result = await _orderService.GetCustomerOrdersAsync(userId, query, ct);
        return result.ToOkResult();
    }
    ...
    public async Task<IActionResult> GetRestaurantOrders([FromRoute] int id, [FromQuery] OrderQuery query, CancellationToken ct)
    {
        ...
        ServiceResult<PaginatedResult<OrderDto>> result = await _orderService.GetRestaurantOrdersAsync(id, userId, query, ct);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult<OrderDto> result = await _orderService.UpdateStatusAsync(id, request, ct);
        return result.ToOkResult();
    }
    ...
    public async Task<IActionResult> CancelOrder([FromRoute] int id, CancellationToken ct)
    {
        ...
        ServiceResult<OrderDto> result = await _orderService.CancelOrderAsync(id, userId, ct);
        return result.ToOkResult();
    }
