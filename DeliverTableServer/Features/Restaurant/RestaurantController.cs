...
public class RestaurantController(IRestaurantService restaurantService) : ControllerBase
{
    ...
    {
        ServiceResult<PaginatedResult<RestaurantDto>> result = await _restaurantService.GetAllAsync(query, ct);
    ...
    {
        ServiceResult<List<RestaurantMapDto>> result = await _restaurantService.GetForMapAsync(query, ct);
        return result.ToOkResult();
    }
        ...
        [FromQuery] RestaurantQuery query, CancellationToken ct, [FromRoute] int? id = null)
    {
        ...
        ServiceResult<PaginatedResult<RestaurantDto>> result = await _restaurantService.GetByOwnerAsync(id.Value, query, ct);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult<DetailedRestaurantDto> result = await _restaurantService.GetByIdAsync(id, ct);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult<DetailedRestaurantDto> result = await _restaurantService.UpdateAsync(id, restaurantDto, ct);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult result = await _restaurantService.DeleteAsync(id, ct);
    ...
    public async Task<IActionResult> Create([FromBody] CreateRestaurantDto creationDto, CancellationToken ct)
    {
        ...
        ServiceResult<RestaurantDto> result = await _restaurantService.CreateAsync(creationDto, ownerId, ct);
