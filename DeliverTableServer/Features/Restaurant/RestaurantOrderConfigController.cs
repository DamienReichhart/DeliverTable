...
public class RestaurantOrderConfigController(IRestaurantOrderConfigService restaurantOrderConfigService) : ControllerBase
{
    ...
    public async Task<IActionResult> GetBlockedSlots([FromRoute] int id, CancellationToken ct)
    {
        ...
        ServiceResult<List<AdminBlockedSlotResponse>> result = await _restaurantOrderConfigService.GetBlockedSlotsAsync(id, userId, ct);
        ...
        CancellationToken ct)
    {
        ...
        ServiceResult<AdminBlockedSlotResponse> result = await _restaurantOrderConfigService.CreateBlockedSlotAsync(id, userId, request, ct);
        if (!result.IsSuccess)
    ...
    public async Task<IActionResult> DeleteBlockedSlot([FromRoute] int id, [FromRoute] int slotId, CancellationToken ct)
    {
        ...
        ServiceResult result = await _restaurantOrderConfigService.DeleteBlockedSlotAsync(id, slotId, userId, ct);
    ...
    {
        ServiceResult<TablesCapacityResponse> result = await _restaurantOrderConfigService.GetTablesCapacityAsync(id, 0, ct);
        return result.ToOkResult();
    }
        ...
        CancellationToken ct)
    {
        ...
        ServiceResult<TablesCapacityResponse> result = await _restaurantOrderConfigService.UpdateTablesCapacityAsync(id, userId, request, ct);
        return result.ToOkResult();
    }
    ...
    public async Task<IActionResult> GetOpeningHours([FromRoute] int id, CancellationToken ct)
    {
        ...
        ServiceResult<RestaurantOpeningHoursResponse> result = await _restaurantOrderConfigService.GetOpeningHoursAsync(id, userId, ct);
        return result.ToOkResult();
    }
        ...
        CancellationToken ct)
    {
        ...
        ServiceResult<RestaurantOpeningHoursResponse> result = await _restaurantOrderConfigService.UpdateOpeningHoursAsync(id, userId, request, ct);
        return result.ToOkResult();
    }
    ...
    public async Task<IActionResult> GetAvailableSlots(
        ...
        CancellationToken ct)
    {
        ServiceResult<RestaurantAvailableSlotsResponse> result = await _restaurantOrderConfigService.GetAvailableSlotsAsync(id, query, ct);
        return result.ToOkResult();
    }
}
