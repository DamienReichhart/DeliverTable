...
namespace DeliverTableServer.Features.Dish;
...
public class DishController(IDishService dishService) : ControllerBase
{
    ...
    {
        ServiceResult<PaginatedResult<DishDto>> result = await _dishService.GetAllAsync(query, ct);
    ...
    {
        ServiceResult<DishDto> result = await _dishService.GetByIdAsync(id, ct);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult<PaginatedResult<DishDto>> result = await _dishService.GetByRestaurantIdAsync(query, id, ct);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult<DishDto> result = await _dishService.CreateAsync(createDishDto, id, image, ct);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult<DishDto> result = await _dishService.UpdateAsync(id, createDishDto, image, ct);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult result = await _dishService.DeleteAsync(id, ct);
