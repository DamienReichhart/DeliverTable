...
public class AdminOrderConfigController(IAdminOrderConfigService adminOrderConfigService) : ControllerBase
{
    ...
    {
        ServiceResult<List<AdminOrderRuleResponse>> result = await _adminOrderConfigService.GetAllRulesAsync(ct);
    ...
    {
        ServiceResult<AdminOrderRuleResponse> result = await _adminOrderConfigService.GetRuleByIdAsync(id, ct);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult<AdminOrderRuleResponse> result = await _adminOrderConfigService.CreateRuleAsync(request, ct);
    ...
    {
        ServiceResult<AdminOrderRuleResponse> result = await _adminOrderConfigService.UpdateRuleAsync(id, request, ct);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult result = await _adminOrderConfigService.DeleteRuleAsync(id, ct);
    ...
    {
        ServiceResult<List<AdminBlockedSlotResponse>> result = await _adminOrderConfigService.GetAllBlockedSlotsAsync(ct);
        return result.ToOkResult();
    }
    ...
    {
        ServiceResult<AdminBlockedSlotResponse> result = await _adminOrderConfigService.GetBlockedSlotByIdAsync(id, ct);
        return result.ToOkResult();
    }
    ...
    public async Task<IActionResult> CreateBlockedSlot([FromBody] AdminCreateBlockedSlotRequest request,
        CancellationToken ct)
    {
        ServiceResult<AdminBlockedSlotResponse> result = await _adminOrderConfigService.CreateBlockedSlotAsync(request, ct);
    ...
    {
        ServiceResult result = await _adminOrderConfigService.DeleteBlockedSlotAsync(id, ct);
        return result.ToNoContentResult();
    }
}
